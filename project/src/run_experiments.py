...
def parse_args():
    ...
    parser.add_argument("--augment_multiplier", type=float, default=None,
                        help="증강 후 봇넷 수 배수 (기본값: 2.0, 예: 1.25 / 1.5 / 2.0)")
...
def main():
    ...
    if args.augment_multiplier is not None:
        env["AUGMENT_MULTIPLIER"] = str(args.augment_multiplier)
    ...
    print(f"  AUGMENT_MULTIPLIER: {env.get('AUGMENT_MULTIPLIER', '2.0')}")
