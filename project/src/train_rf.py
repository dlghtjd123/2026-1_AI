...
# 수정 - project/ 폴더를 이름으로 명시적으로 찾기
_SRC_DIR   = Path(__file__).resolve().parent        # .../project/src
_PROJECT   = _SRC_DIR.parent                        # .../project
_ROOT      = _PROJECT.parent                        # .../2026-1_AI

MODEL_DIR  = _ROOT / "artifacts" / "models"
RESULT_DIR = _ROOT / "artifacts" / "results"

# DATA_DIR는 project/ 안에 있으므로 그대로 유지
DATA_DIR   = _PROJECT / "data" / "processed" / "winflat"  # rf, xgb
# DATA_DIR = _PROJECT / "data" / "processed" / "seq"      # cnn_lstm
